...
<body class="font-sans text-gray-700">
  ...
  <div class="p-8">
    <div class="flex justify-between items-center mb-4">
      <h2 class="text-pink-700" style="font-size: 35px; font-weight: bold;">Customer List</h2>
      <a href="a.add_customer.php" class="inline-block px-4 py-2 bg-pink-600 text-white rounded hover:bg-pink-700">
        Add New Customer
      </a>
    </div>
    ...
    <div class="overflow-x-auto bg-white rounded-lg shadow-md p-6">
      <table class="min-w-full border border-pink-100">
        ...
        <tbody>
          ...
          foreach ($customers as $index => $customer) {
            ...
            echo '<tr class="border-b hover:bg-pink-50">
      ...
      <td class="text-center px-4 py-2">'.$totalOrders.'</td>
      <td class="text-center px-4 py-2">
        <a href="a.view_customer.php?id='.$customer['CUSTID'].'" class="inline-block px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 mr-1">View</a>
        <a href="a.edit_customer.php?id='.$customer['CUSTID'].'" class="inline-block px-3 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600 mr-1">Edit</a>
        <a href="a.delete_customer.php?id='.$customer['CUSTID'].'" class="inline-block px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600" onclick="return confirm(\'Are you sure you want to delete this customer?\')">Delete</a>
      </td>
    </tr>';
          }
          ?>
