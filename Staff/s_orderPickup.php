...
<body class="bg-gray-100">  
    ...
    <div class="flex items-center justify-center h-screen">  
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-3xl">  
            <h2 class="text-2xl font-bold mb-6 text-center">Pickup Orders</h2>  
            <div class="overflow-x-auto">  
                <table class="min-w-full bg-white border border-gray-300">  
                    ...
                    <tbody>  
                        ...
                        $sql = "SELECT ORDERID, P_TIME, P_STATUS FROM PICKUP"; // Adjust the query as necessary  
                        ...
                        while ($order = oci_fetch_array($stmt, OCI_ASSOC + OCI_RETURN_NULLS)) {  
                            ...
                            <tr class='hover:bg-gray-100'>  
                                ...
                                <td class='py-2 px-4 border-b'>{$order['P_STATUS']}</td>  
